...
export function DeleteAccountPopUpBox() {
    ...
    return (
        ...
        >   
            {/* Modal Card */}
            <div 
                className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-6 sm:p-8 border border-gray-200 transform transition-all"
            ...
            >
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                    ...
                    <button 
                        className="flex-1 px-4 py-3 bg-red-600 hover:bg-red-700 text-white font-medium rounded-lg transition-colors duration-200 shadow-sm"
